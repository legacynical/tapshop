...
For canonical internal documentation, start with [`docs/_index.md`](./docs/_index.md). The old combined `TAPSHOP/` path is historical; the active code now lives in `TAPSHOP-macos/` and `TAPSHOP-windows/`.
